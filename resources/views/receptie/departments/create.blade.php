...
@section('title', 'Adaugă Specialitate - Recepție')

@section('content')
<div class="page-header">
    <h1>Adaugă Specialitate</h1>
    <p>Completează formularul pentru a adăuga o specialitate în clinica ta</p>
</div>

<form method="POST" action="{{ route('receptie.departments.store') }}" style="max-width: 700px;">
    @csrf
    ...
    @include('receptie.departments._icon-picker', ['selectedIcon' => old('icon', 'fa-stethoscope')])
